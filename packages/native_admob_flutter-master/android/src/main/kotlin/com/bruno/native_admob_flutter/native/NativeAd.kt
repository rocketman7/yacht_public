...
fun TextView.applyText(data: Map<*, *>, context: Context) {
    val view = this
    // val typeface: Typeface? = ResourcesCompat.getFont(this, R.font.ibm_plex_sanskr_bold);
    // val typeface = Typeface.createFromAsset("font/ibm_plex_sanskr_bold.ttf")
    // val typeface = resources.getFont(R.font.ibm_plex_sanskr_bold)
