...
class _UserSurveyViewState extends State<UserSurveyView> {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<UserSurveyViewModel>.reactive(
        viewModelBuilder: () => UserSurveyViewModel(),
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Flexible(
                                              ...
                                              child: ElevatedButton(
                                                onPressed: () async {
                                                  print(model.finalizingSurvey);
                                                  if (model.finalizingSurvey ==
                                                      true) {
                                                  } else {
                                                    await model.finalizeSurvey(
                                                        model.uid,
                                                        notifyHomeView);
                                                  ...
                                                  return Padding(
                                                    ...
                                                    child: Container(
                                                        constraints:
                                                            BoxConstraints(
                                                                minHeight: 50),
                                                        decoration: model.userSurveyModel.surveyQuestions[model.currentStep - 1].multipleChoice ==
                                                                false
                                                            ? BoxDecoration(
                                                                borderRadius:
                                                                    BorderRadius.all(
