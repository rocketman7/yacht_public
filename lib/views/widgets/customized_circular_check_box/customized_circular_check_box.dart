...
///
///  * [Checkbox]
class CustomizedCircularCheckBox extends StatefulWidget {
  ...
  @override
  _CustomizedCircularCheckBoxState createState() =>
      _CustomizedCircularCheckBoxState();
}
  ...
  Widget build(BuildContext context) {
    ...
    switch (widget.materialTapTargetSize ?? themeData.materialTapTargetSize) {
      case MaterialTapTargetSize.padded:
        size = const Size(
            2 * kRadialReactionRadius + 2.0, 2 * kRadialReactionRadius + 2.0);
        break;
...
const double _kEdgeSize = CustomizedCircularCheckBox.width;
