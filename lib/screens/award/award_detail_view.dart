                                      ...
                                      GestureDetector(
                                        ...
                                        onTap: () {
                                          ...
                                          _mixpanelService.mixpanel.track(
                                            'Award Detail Swipe',
                                            properties: {
                                              'Award Detail Swipe Page To Sub League Name':
                                                  _awardViewModel
                                                      .allSubLeagues[
                                                          _awardViewModel
                                                              .pageIndexForUI
                        ...
                        GestureDetector(
                            onTap: () {
                              _mixpanelService.mixpanel
                                  .track('League Ranking', properties: {
                                'Sub League Index':
                                    _awardViewModel.pageIndexForUI.value,
                              });
  ...
  Widget build(BuildContext context) {
    return Obx(() => Column(
          children: [
            ...
            SizedBox(
                height: correctHeight(
                    9.w, 0.w, subLeagueAwardLabelTotalValueTextStyle.fontSize)),
            Row(
                ...
                Text(
                    ...
                    style: subLeagueAwardLabelPLTextStyle.copyWith(
                        color: plusOrminusColor(
                            _awardViewModel.totalCurrentValue[
                                _awardViewModel.pageIndexForUI.value],
                            _awardViewModel.totalValue[
                                _awardViewModel.pageIndexForUI.value]))),
              ],
            ),
            SizedBox(
                height: correctHeight(
                    6.w, subLeagueAwardLabelTotalValueTextStyle.fontSize, 0.w)),
            Container(
              height: 1.w,
              width: double.infinity,
              color: yachtLightGrey,
            ...
            Column(
              ...
              children: _awardViewModel
                  ...
                  .map((i, element) => MapEntry(
                      i,
                      (_awardViewModel.isMaxLabel[_awardViewModel
